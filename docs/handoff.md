...
| `pnpm format:check` | 🟦 緑 | — |
| `pnpm spell` | 🟦 緑 | **303 ファイル**（+20）。🟦 **辞書 0 語追加**（Storybook 既定の自動ドキュメント用タグを書きかけたが、repo の語彙 `own` に揃えて消した） |
