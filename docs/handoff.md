...
| **手8d** | 🆕 **製品層の部品を実装する**（設計を 4 件のコードに落とし、機械ゲートまで通す） | [手8d](手順/手8d_製品層の部品実装.md) | ✅ **done**（2026-08-07）。★ 器 A 確定・新しい赤ゼロ・[DR-0074](DR/DR-0074-we-wrote-the-same-deviations-ourselves.md)。🟥 **PR は未作成＝人に提案中** |
...
| # | やること | 状態 |
| --- | --- | --- |
| 1 | **PR を出してマージする**（作業ブランチ → `main`。[DR-0068](DR/DR-0068-merge-through-pull-requests.md) によりマージは人） | 🟥 **提案済み・未実行** |
