...
- ★★★ 🆕 **部品3 が完了した — `DatePicker` を出荷し、バーが見ていなかった 4 件を全部拾った**（2026-08-09・[手順書](手順/部品3_DatePickerと射程の外の3件.md)・[実行記録 §部品3](実行記録.md)・ブランチ `da-nang`・**PR 待ち**）。
...
> | **3** | ✅ ~~**部品3 を C3-01 から実行する**~~ **完了**（ブランチ `da-nang`・**PR 待ち**） | ✅ |
> | **3b** | 🟥 ★★ **この PR をマージする** | 🟥 **人**（[DR-0068](DR/DR-0068-merge-through-pull-requests.md)） |
