...
| **工程2** | データの器（MSW ＋ データモデル） | ✅ **done**（2026-08-07・[手順書](手順/工程2_データの器_MSWとデータモデル.md)）。★ Q4 が本体（取得の層の新設）・DR-0085〜0087・[データモデル.md](データモデル.md)。🟥 **マージは人** |
...
>
> 1. 🟥 **工程2 の PR を人がマージする**（[手順書 §2](手順/工程2_データの器_MSWとデータモデル.md) の D1〜D13 は推奨どおりの Claude 判断・事後承認待ち。**異議があれば言ってほしい**——全件 git で戻せる。とくに **D4**（取得の層をコアに置かない）と **D12**（lint 2 本を戻した）は工場の思想に触る）
