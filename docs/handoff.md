...
- ★★★ 🆕 **部品6 が完了した — 「130/130 緑」を面積で読み直したら、79% は何も主張していなかった**
  （2026-08-09・[手順書](手順/部品6_緑の面積を数える.md)・[実行記録 §部品6](実行記録.md)・ブランチ `geneva`・**PR 待ち**）。
...
> | # | やること | 誰がやるか |
> | --- | --- | --- |
> | **A** | 🟥 ★★ **部品6 の PR をマージする** | 🟥 **人**（[DR-0068](DR/DR-0068-merge-through-pull-requests.md)） |
