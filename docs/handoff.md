...
最終更新: 2026-08-07（★★★ 🆕 **repo の役割が変わった** — PoC への移送を捨て、**「使い回せる UI を作る工場」**へ。Next → **React + Vite**。作る画面は Redmine の 5 画面（**編集あり**）／データは **MSW ＋ Storybook**／チャート・ガントは**調査工程を挟む**。**新しい地図＝[工場の段取り.md](工場の段取り.md)**。★★ **2 回ルールを廃止した**（[DR-0077](DR/DR-0077-abolish-the-two-occurrence-rule.md)・ユーザー判断）。**回数は判断の条件ではなく記録する観測量**。🆕 **手8f（8 周目）の手順書を起こした**——問いの本体は「同一入力を 2 度打つと出力は同じか」＝ 7 周ぶんの読みの校正。🟥 **§2 の D1〜D8 はユーザー判断待ち**）
...
- ★★★ 🆕 **repo の役割が変わった**（**ユーザー判断 2026-08-07**）。**新しい地図＝[工場の段取り.md](工場の段取り.md)。**
  ...
  - 🟥 **次の一手は工程0（役割の確定・記録だけ）。**D1〜D5 がユーザー判断
...
- ★★ 🆕 **手8f（8 周目）の手順書を起こした**（[手8f](手順/手8f_8周目_同一入力の再現性と過程の観測.md)・2026-08-07・status `planned`）。
  ...
  - 🟥 **ユーザー判断待ちは D1〜D8 の 8 件**（とくに D1・D4・D8）
...
> ★★ 🆕 **2026-08-07: repo の役割が変わった。**PoC への移送を捨て、**「使い回せる UI を作る工場」**にする（ユーザー判断）。
> **新しい地図は [工場の段取り.md](工場の段取り.md)。**下記の手8f 以下は**捨てる工程**なので、着手しない。
> **次の一手は [工場の段取り §工程0](工場の段取り.md)（役割の確定・記録だけ）。**
