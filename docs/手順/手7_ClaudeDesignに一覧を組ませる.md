...
next_action: '🟥 §2 D8（2 周目を回すか）を決める。推奨 A（事前登録どおり・末尾に 1 文だけ足す）。1 周目は Q1 🟦「使う」・Q2 🟦「効いた」・Q3 🟨・Q4 🟥（Card の欠落が手組みを生んだ）'
---
...
| **D5** | **素材層の不足が出たとき、その場で 2 周目を回すか** | **A** 回す（素材層 16 件を足して再同期）／ **B** 記録だけして手7 は 1 周で閉じる | 🟦 **B**（ユーザー判断 2026-08-01） | §2.5 | 🟦 戻せる |
...
| # | 論点 | 選択肢 | 決定 | 根拠 | 戻せるか |
| --- | --- | --- | --- | --- | --- |
| **D8** | 2 周目（H7-07）を回すか | **A** 事前登録どおり回す（末尾に 1 文だけ足す）／ **B** 回さず Q1 を確定させて閉じる／ **C** 予定を変えて「宣言した語彙だけを使え」と明示する 2 周目にする | 🟥 **未決** | §2.8 | 🟦 戻せる |
